...
export default () => {
    ...
    const [_, _2, resetValue] = useLocalStorage(Constants.storage.autoLoginSession, "");
    ...
    useEffect(() => {
            ...
            if (commGetMeResult.error?.graphQLErrors && commGetMeResult.error.graphQLErrors.length > 0){
                setMe(undefined);
                setSession('');
                resetValue();
            }
